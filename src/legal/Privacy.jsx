  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        when you visit and interact with my portfolio website. By accessing this
        website, you agree to the terms outlined in this policy. If you do not
        agree with the terms, please do not use this site.
      </p>

      <h2>1. Information We Collect</h2>

      <p>We collect two types of information from visitors:</p>
      ...
      <p>
        This information is collected when you voluntarily submit it through
        contact forms, email subscription forms, or similar features on the
        website.
      </p>

      <h3>1.2 Non-Personal Information</h3>
      <p>
        Non-personal information includes data that cannot be used to identify
        you, such as:
      </p>
      <ul>
        <li>IP address</li>
      ...
      <p>
        ...
        However, disabling cookies may affect the functionality of some parts of
        the website.
      </p>
      ...
      <p>
        ...
        However, no transmission of data over the internet is entirely secure.
      ...
      <p>
        ...
        the information we hold about you. If you wish to exercise any of these
        rights, please contact us at adamgemechu@gmail.com.
      </p>

      <h2>8. Changes to This Privacy Policy</h2>
      <p>
        We may update this Privacy Policy from time to time. Any changes will be
        posted on this page with the updated revision date. We encourage you to
      ...
      <ul>
        <li>Email: adamgemechu@gmail.com</li>
      </ul>
    </div>
  );
}
